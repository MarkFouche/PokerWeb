...
public class Routes implements ApplicationRoutes {
    ...
    public void init(Router router) {
        ...
        router.GET().route("/lobby").with(GameController.class, "getLobby");
        router.GET().route("/lobby_update").with(GameController.class, "updateLobby");
        router.GET().route("/single_lobby_update").with(GameController.class, "updateSingleGameLobby");
        router.GET().route("/{hostname}/host_game").with(GameController.class, "hostGame");
        router.GET().route("/{hostname}/join_game").with(GameController.class, "joinGame");
        router.GET().route("/start_game").with(GameController.class, "startGame");
